...
## 3 Mar 2014: Increase duration by 1000 time steps
## (instead of 700)

## 21 Feb 2014:
## a. Add attribute "vl.at.art.cessation"
## b. Run estimation routine again

## 20 Feb 2014: Add new attributes:
## "cd4.at.art.initiation"
## "cd4.at.art.cessation"
## "vl.at.art.cessation"

## 10 Feb 2014: Increase duration 700

## 6 Feb 2014: Increase duration

## 30 Jan 2014: Clear bugs in "vl.art.traj.slope" --
## was assigned to NA for those initially infected

## 3 Dec 2013:
## a. Set "num.of.pregnancies" to 0 for all who are not pregnant,
## and 1 to those who are pregnant at entry

## b. File "estimation_za_phase2_entr18_max_deg_unconstrained_params_rev_d8d.RData"
## constains starting network for simulations upto 3 Dec without number of pregnancies
## recorded. Now create new object
## "estimation_za_phase2_entr18_max_deg_unconstrained_params_rev_numpreg_d8d.RData"
## with number of pregnancies recorded.

## 16 Nov 2013: With revised parameters. Chose unconstrained model
## because data for both men and women show longer tails than max degree 4.

## 14 Nov 2013: I was thinking one of the reasons for longer
## estimation times might be there is collinearlity in the statistics
## we specify. One place where such collinearity might occur is when I
## specify both the diagonal and the row and column sums. I tried
## leaving out the diagonals, and just trying the row and diagonal
## sums (with one statistic left out for each). The resulting age
## mixing matrices then look really poor on the diagonals, indeed (as
## I realized later) the whole meaning of assortative mixing is
## observing more ties on the diagonal than are expected by chance
## (proportional mixing, in this case).

## 13 Nov 2013: Estimate model with max degree unconstrained to
## compare how networks simulated from this model compare with networks
## simulated from model with max degree constrained to 4.
...
source("../params_za_d2.R") #16Nov13: with revised parameter
  ...
  ## pregnancy status
     ...
     ## overwritten with age specific fertility rates for women below
      ...
      set.vertex.attribute(n0, "num.of.pregnancies", 0)
                                        #3Dec13: set to 0 for everyone initially
      set.vertex.attribute(n0, "num.of.pregnancies", 1,
                           pregnant.yes)
                                        #3Dec13: update to 1 for pregnant at time 0
...
## BIOLOGICAL ATTRIBUTES 
      ...
      for (i in 1:N){
       ...
       ## 30Jan2014: vl.art.traj.slope assignmend for initia
    ...
    ## 20Feb14: Back-calculate new attributes: CD4 at ART initiation,
...
#####################################################
      ...
      save.image(file="estimation_za_d9d_vl.art.traj.slope_dur1000_newatts.RData") 
