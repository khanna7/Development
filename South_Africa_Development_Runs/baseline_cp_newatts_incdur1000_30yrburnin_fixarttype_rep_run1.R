...
## 27 May 2014: Repeat baseline CP runs

## 7 May 2014: Repeat Option B cp runs 

## 28 Apr 2014:
## Adapt for South Africa. Fix Option B and rerun,
## initiatlly all pregnant women on ART type
## were stopping treatment 1 year after breastfeeding.
## Fixed error in "update.treatment_d12.R" so that only
## pregnant women with CD4>350 at initiation will stop
## ART one year after delivery. 


## 2 March 2014: Redo Option B runs --
## MOSIX node died on 28 Feb (this should actually be
## 3 March). 
...
## STATNET-Related Files and Packages
  ...
  ## SIMULATION-Related Files and Packages
      ...
      load("burnin.12March_ZA_phi004_incdur1000_newatts_30yrburn_run1.RData") #13Mar14
       ...
       source("../update.treatment_d12.R") #28Apr14
...
#####################################################
   ...
   date <- "27May_UG_baseline_cp_run1"
