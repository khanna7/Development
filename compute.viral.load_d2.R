## 25 Jul 2013: Add modification in viral load increasae for women post-ART
            ...
            ## 29May13: should this go to midpoint too??
               ...
               if(!is.na(time.since.art.cessation[i]) &&
                 ...
                 viral.load.today[i] <- viral.load.today[i] + vl.art.traj.slope[i]
                          ...
                          time.since.art.cessation[i] >= sc.art.postcess.ret.bl){
                 ## for post-scART women who have crossed pre-ART viral load 

                     ## code-chunk below taken from viral load computations for
                     ## treatment naive individuals, as given above
                     #########################################################
