## Update treatment
  ...
  ## 8 Jan 2014: Option B does not seem to be working -- 
  ## make changes here
  ...
  function(nw, verbose,
       ...
       ## eligible at CD4 count ~350 cells/mm3
          ...
          #########################################################################
          ## 8Jan14: ART status for "others" (not pregnant women) is updated here.
          ##         Condidional below not necessary.
          ## if (scenario == "baseline" || scenario == "pmtct.b+" || scenario == "option.b"){
                                        # 8Jan14: Remove conditional
