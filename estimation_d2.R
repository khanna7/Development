...
##############
 ...
 ## ART Status (Whether currently on treatment
  ...
  ## Viral Load,
     ...
     ### If infected and on treatment and adherent, set to "undetectable" (=0?)
     ### If infected and untreated, or,
     ### on treatment but not adherent, then
     ### dependent on time since infection.
  ...
  ## CD4 Counts
     ...
     ### Starting CD4 counts for infected men and women are different.
     ### Rates are about the same.
     ### But they are age-specific.
     ### Wtd avg based on age distribution may be better because
     ### decline based on age of infection or current age?
...
#### Fit cross-sectional model to formation, and apply Carnegie correction 
