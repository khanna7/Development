          ...
          if (male.curr.age[i] >= 15 && male.curr.age[i] < 20){
            ...
            asmr.male.out[i] <- 1
             ...
             if (is.na(male.art.status[i]) ||
               ...
               if (male.cd4.today[i] %/% 200 == 0){ #quotient operator is needed
                 asmr.male.out[i] <- 27.0*size.of.timestep/(100*365) #14Jan14: Badri, adjust for size.of.timestep
               } else if ((male.cd4.today[i] >= 200) && (male.cd4.today[i] < 350)){
                 asmr.male.out[i] <- 8.0*size.of.timestep/(100*365) 
               } else if ((male.cd4.today[i] >= 350)){
                 asmr.male.out[i] <- 5*size.of.timestep/(100*365)
               }
          ...
          if (female.inf.status[i] == 0){
            if (female.curr.age[i] >= 15 && female.curr.age[i] < 20){
             ...
             if (is.na(female.art.status[i]) || female.art.status[i] == 0){
               ...
               if (female.cd4.today[i] %/% 200 == 0){ #quotient operator is needed
                 asmr.female.out[i] <- 27.0*size.of.timestep/(100*365) #14Jan14: Badri adjust for size.of.timestep
               } else if ((female.cd4.today[i] >= 200) && (female.cd4.today[i] < 350)){
                 asmr.female.out[i] <- 8.0*size.of.timestep/(100*365) 
               } else if ((female.cd4.today[i] >= 350)){
                 asmr.female.out[i] <- 5*size.of.timestep/(100*365)
               }
