...
#####################################################
  ...
  hetdeg.diag.sim.est9d <- simulate(n0,
   ...
   save(hetdeg.diag.sim.est9d, file="hetdeg.diag.sim.est9d.RData")
...
## Save Object
#####################################################
  save.image(file="estimation_uganda_d9d_agemix_diag_lowtriangle.RData")
#####################################################



## 1Oct2013: test age mixing
age.mix.mat <- mixingmatrix(hetdeg.diag.sim.est9b, "age.cat")$matrix
