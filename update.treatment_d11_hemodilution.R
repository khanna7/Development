## Update treatment
  ...
  ## 25 Apr 2014: For hemodilution -- differenitate
  ## "eligible.cd4" to "eligible.cd4.male" and "eligible.cd4.female"
  ...
  function(nw, verbose,
           scenario,
           #eligibile.cd4,
           eligible.cd4.male, #25Apr2014
           eligible.cd4.female, #25Apr2014
       ...
       ## eligible at CD4 count ~350 cells/mm3
         ...
         if (scenario == "baseline" || scenario == "pmtct.b+" || scenario == "option.b"){#14Oct13,
           ...
           ## 25Apr14: Comment out below for hemodilution
           ## cd4.below.eligible <- which(nw%v%"cd4.count.today" <=
           ##                                          eligible.cd4) 
           cd4.below.eligible.male <- which(nw%v%"cd4.count.today" <=
                                               eligible.cd4.male) #25Apr14
           cd4.below.eligible.male <- which(nw%v%"cd4.count.today" <=
                                               eligible.cd4.female) #25Apr14
           ...
           ## 25Apr14: Comment out below
           ## untreated.art.eligible <- intersect(untreated.male,
           ##                                     cd4.below.eligible)
           ## untreated.art.eligible <- intersect(untreated.female,
           ##                                     cd4.below.eligible)
           
           untreated.art.eligible.male <- intersect(untreated.male,
                                                    cd4.below.eligible.male)
           untreated.art.eligible.female <- intersect(untreated.female,
                                                      cd4.below.eligible.female)
