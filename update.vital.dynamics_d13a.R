    ...
    ## 28 Oct 2013:
    ## Implement (a) and (b) below for new arrivals
    ...
    ## and, Remove values for all arguments inside the function
     ...
     # 26 Aug 2013: Update active nodes
       ...
       ## call that function here.
           ...
           male.mu.non.aids <- assign.mortality.male(male.curr.age,
                                                     ...
                                                     male.cd4.today,
                                                     male.art.status,
                                                     size.of.timestep=size.of.timestepw)
      ...
      ## } # This loop approach is temp to get around bug in network
       ...
       if (length(nodes.to.activate)>0) { ## if new nodes enter the network
         ...
         ## update relevant attributes here 
          ...
          nw <-  set.vertex.attribute(nw, "num.of.pregnancies", 0,
                                      nodes.to.activate) #28Oct13

          nw <-  set.vertex.attribute(nw, "cd4.of.preg.at.supp.time.art.init", NA,
                                      nodes.to.activate) #28Oct13
