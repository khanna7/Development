...
## 11 Aug 2013: Source transmission version 6, with new system to record
## prevalence and incidence at every time step.
...
#####################################################
  ...
  ## SIMULATION-Related Files and Packages
      #source("common.functions_d7.R")
       ...
       ## source("transmission_d5.R") # 11Aug13: to use new system for recording data
       source("transmission_d6.R")
...
date <- "11Aug13_comp_dur.inf-based-death-limited-to-noART_d2"
