...
#####################################################
  ...
  # to.specify <- c(1, 6, 9, 11, 13, 14, 16) # To specify: str zeros --
                                           ...
                                           # and,
                                           # diagonal entries
  to.specify <- c(1, 3, 4, 6, 9, 11, 13, 14, 16)
...
#####################################################
  ...
  fit <- ergm(formation.n0,
              ...
              #target.stats.with.age.diag.strzero,
               target.stats.age.mix.spec.diag.strzero.mw31.41,
  ...
  hetdeg.diag.sim.est9b <- simulate(n0,
   ...
   save(hetdeg.diag.sim.est9b, file="hetdeg.diag.sim.est9b.RData")
...
## Save Object
#####################################################
  save.image(file="estimation_uganda_d9b_agemix_diagstrzero_mw31.41.RData")
#####################################################
