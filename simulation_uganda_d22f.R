...
## 29 Sep 2013: Debug "assign.pregnancy" here. I don't
## attempt to restrict to cross-sectoional networks only in
## "assign.pregnancy_d5d2.R." Trying to restrict only to
## cross-sectional networks creates problems of mapping between the
## cross-sectional and full networks.
  ...
  ## SIMULATION-Related Files and Packages
      #source("common.functions_d7.R")
       ...
       # source("assign.pregnancy_d5d.R") #13Sep13: Immaculate conception WO correction
        source("assign.pregnancy_d5d2.R") #16Sep13: Correct loop -- w corrn factor.
       # source("assign.pregnancy_d5d3.R") #25Sep13: Correction on cross network.
...
date <- "29Sep13_10pc_3phi_1300steps_run2"
