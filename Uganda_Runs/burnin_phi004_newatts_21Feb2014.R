...
## 21 Feb 2014: With new attributes added to differentiate
## post-cessation trajectories in Option A and B:
## a. With new attributes
## b. Add "sc.art.postcess.ret.bl" to 'compute.cd4.count"
## function
## c. Put in new estimation object
## d. Add both arguments "optB.cess.time" and "optB.vl.postcess.ret.bl" to "assign.pregnancy" and the latter and
## and "sc.art.postcess.ret.bl"
## to the "compute.cd4.count" function

## 31 Jan 2014: Rerun with identical params as
## 30 Jan 2014, but the 30th Jan run was not done in BATCH mode
## so I had to rerun.
...
## 17 Jan 2014: Rerun for 1040 timesteps -- exactly
## 40 years.
...
## STATNET-Related Files and Packages
  ...
  ## Starting Network
      load("estimation_uganda_d13a.RData") #30Jan14
  ...
  ## SIMULATION-Related Files and Packages
       ...
       source("../params_uganda_d3.R") # ultimately take this out of here -- should
...
#####################################################
      ...
      date <- "21Feb_UG_phi004_newatts_run2"
    ...
    for (time in 2:timesteps) {
      ...
      nw <- assign.pregnancy(nw, verbose=TRUE,
        ...
        nw <- compute.cd4.count.sexage.acct(nw, verbose=FALSE,
                                               ...
                                               optB.vl.postcess.ret.bl#21Feb14
                                               )
