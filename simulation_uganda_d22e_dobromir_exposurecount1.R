...
## 22 Sep 2013: Count number of exposed
...
## STATNET-Related Files and Packages
  ...
  ## SIMULATION-Related Files and Packages
      #source("common.functions_d7.R")
       ...
       source("transmission_d9_d1.R") # 22Sep13: count exposures
...
date <- "22Sep13_0phi_exposure_count_run2"
...
#######################################################
  ...
  for (time in 2:timesteps) {   
      ...
      nw <- update.vital.dynamics(nw, verbose=FALSE,
                                  ...
                                  phi=phi.zero, ##22Sep13: 0 phi to count num exposed
