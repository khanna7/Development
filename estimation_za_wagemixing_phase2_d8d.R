...
#####################################################
  ...
  formation <- ~edges+
                ...
                b1starmix(k=1,
                          ...
                          diff=TRUE)+
                #b1factor("age.cat", base=1)+
                 b1factor("age.cat", base=c(1:2))+
                #b1factor("age.cat", base=c(3:4))+
                #b1factor("age.cat", base=c(2:4))+
                #b2factor("age.cat", base=1)
                 b2factor("age.cat", base=c(1:2))
                #b2factor("age.cat", base=c(3:4))
                #b2factor("age.cat", base=c(2:4))
  ...
  #age.b1factor <- apply(age.mixing.all.stat, 1, sum)
  ...
  #age.b1factor.spec <- age.b1factor[1:2]
  #age.b1factor.spec <- age.b1factor[1]
                         
  #age.b2factor <- apply(age.mixing.all.stat, 2, sum)
  ...
  #age.b2factor.spec <- age.b2factor[1:2]
  #age.b2factor.spec <- age.b2factor[1]
...
#####################################################
       ...
       save.image(file="estimation_za_phase2_d8d.RData")
                                        # max degree of men and women is 5
