...
## 1 Oct 2013: a. Simulate from age mixing matrix with only diagonal entries
## and structural zeros specified.

## b. In version "d23b", simulate with only entries in upper-right triangular
## and lower-left triangular matrix specified. 

## c. Add partnership duration restricted to ages 15 to 55.
...
#####################################################
  ...
  rm(list=ls())
      ...
      # load(file="estimation_uganda_d9e_agemix_uptriangle_lowtriangle.RData") #1Oct13
        load(file="estimation_uganda_d9f_agemix_uptriangle_lowtriangle_durn15to55.RData")
...
date <- "1Oct13_inc_fert_rate_wagemix_uptrlowtr_durn15to55_1300steps_run2"
