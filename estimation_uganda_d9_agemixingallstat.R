...
## 24 Oct 2013: Now that we have 64-bit computing, mabe we can fully specify
## the age mixing matrix.
...
## Save Object
#####################################################
#  save.image(file="estimation_uganda_d9_agemix_nodiff.RData")
  save.image(file="estimation_uganda_d9_agemix_allstat.RData")
#####################################################
