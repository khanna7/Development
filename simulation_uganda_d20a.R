...
## 26 Aug 2013: Experiment with higher growth rates: 4phi and 5phi.

## 23 Aug 2013: Exactly the same as version "d7" 
## except 10% infected at start here.
...
#####################################################
  ...
  rm(list=ls())
      ...
      # load("estimation_uganda_d6b.RData") #22Aug13:Simulate 15% infection at start
       load("estimation_uganda_d7a.RData") #age-based duration of infection at time of inf.
...
date <- "26Aug13_dur_inf_by_age_10pc_5phi_1300steps_run4"
