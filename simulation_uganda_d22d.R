...
## STATNET-Related Files and Packages
  ...
  ## SIMULATION-Related Files and Packages
      #source("common.functions_d7.R")
       ...
       # source("assign.pregnancy_d5c.R") #13Sep13: Immaculate conception with correction
         source("assign.pregnancy_d5c1.R") #16Sep13: Correct loop. 
...
date <- "16Sep13_10pc_3phi_immconc_withcorrn_recnumpregtest_testbinompregob_1300steps_run2"
