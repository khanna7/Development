...
## 13 Nov 2013: convergence issues burnin chain mixing poorly. redo by only
## specifying diagonal entries on age mixing matrix.
...
#####################################################
       ...
       save.image(file="estimation_za_phase2_entr18_max_deg_unconstrained_diagonly_d8d.RData")
                                        # max degree of men and women is 5
