## 7 Jul 2013: Change ASMR to realistic values

## 6 Jul 2013: Implement model with infection-based mortality rates --
## ASMR for HIV-negative individuals
## CD4-based for HIV-positive individuals

## 5 Jul 2013: Made corrections to adding changes in viral load for different
## types of treatment
...
## load("estimation_uganda_d3.RData") ## move this back down after changing version
     ...
     ## SIMULATION-related files and packages
       ...
       source("update.vital.dynamics_d6.R")
             ## added infection-based mortality rates
       source("assign.pregnancy_d2.R")
       source("update.biological.parameters_d9.R")
             ## with code for different viral load trajectories for diff. ART states
             ## added "art.type" for non-pregnant women initiating ART
...
#####################################################
  ...
  ## Demographic Parameters
     ...
     asmr.perperson.perday <-
  c(6.87671232876712E-006,
