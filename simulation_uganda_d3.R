## 27 Adapt with revised definition of timestep (as 14 days)
...
## of a given age
  ...
  ## Epidemiologic Parameters
     ...
     per.day.untreated.cd4.decline <- untreated.cd4.perstep.decline
     ...
     min.chronic.infectivity.unadj <- 0.00497/2.89 # changed to include infection at log 2
