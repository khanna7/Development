  ...
  function(nw, verbose=TRUE,
       ...
       ## eligible at CD4 count ~350 cells/mm3
         ...
         if (scenario == "baseline"){
           ...
           set.vertex.attribute(nw, "art.status", 1, untreated.art.begin.male)
           set.vertex.attribute(nw, "art.status", 1, untreated.art.begin.female)
         ...
         ##   NA for not infected )
             ...
             nw <- compute.cd4.count(nw, verbose=TRUE,
         ...
         ## first in untreated
             ...
             nw <- compute.viral.load(nw, verbose=TRUE,
                                      time.infection.to.peak.viremia=
                                      time.infection.to.peak.viremia,
