...
# 26 Aug 2013: Experiment with higher growth rates: 4*phi and 5*phi.

## 23 Aug 2013: Exactly the same as version "d7" and "d7a" --
## except 6% infected at start here.
...
#####################################################
  ...
  rm(list=ls())
      ...
      # load("estimation_uganda_d6b.RData") #22Aug13:Simulate 15% infection at start
       load("estimation_uganda_d7b.RData") #age-based duration of infection at time of inf.
...
date <- "26Aug13_dur_inf_by_age_6pc_5phi_1300steps_run4"
